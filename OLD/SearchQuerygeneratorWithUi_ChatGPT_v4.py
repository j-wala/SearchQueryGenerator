import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QTableWidget, QTableWidgetItem, QVBoxLayout, QWidget, QCheckBox, QTextEdit, QHeaderView, QPushButton, QHBoxLayout
import random
...
class SearchInterface(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("Search Query Generator V4")
    ...
    def randomize_checkboxes(self):
        num_to_tick = random.randint(2, 4)
